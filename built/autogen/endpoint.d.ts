...
export type Endpoints = {
    ...
    'admin/emoji/add-tags-bulk': {
        req: AdminEmojiAddTagsBulkRequest;
        res: EmptyResponse;
    };
    'admin/emoji/add': {
    ...
    'admin/emoji/remove-tags-bulk': {
        req: AdminEmojiRemoveTagsBulkRequest;
        res: EmptyResponse;
    };
    ...
    'admin/emoji/set-tags-bulk': {
        req: AdminEmojiSetTagsBulkRequest;
        res: EmptyResponse;
    };
    ...
    'auth/accept': {
        req: AuthAcceptRequest;
        res: EmptyResponse;
    };
    'auth/session/generate': {
        req: AuthSessionGenerateRequest;
        res: AuthSessionGenerateResponse;
    };
    'auth/session/show': {
        req: AuthSessionShowRequest;
        res: AuthSessionShowResponse;
    };
    'auth/session/userkey': {
        req: AuthSessionUserkeyRequest;
        res: AuthSessionUserkeyResponse;
    };
    'blocking/create': {
    ...
    'i/authorized-apps': {
        req: IAuthorizedAppsRequest;
        res: IAuthorizedAppsResponse;
    };
    'i/change-password': {
...
export declare const endpointReqTypes: {
    readonly 'drive/files/create': "multipart/form-data";
};
