...
export type AdminEmojiAddTagsBulkRequest = operations['admin___emoji___add-tags-bulk']['requestBody']['content']['application/json'];
...
export type AdminEmojiRemoveTagsBulkRequest = operations['admin___emoji___remove-tags-bulk']['requestBody']['content']['application/json'];
...
export type AdminEmojiSetTagsBulkRequest = operations['admin___emoji___set-tags-bulk']['requestBody']['content']['application/json'];
